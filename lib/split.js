...
//        let text;
//        try {
//            console.error('ok - trying to set text for:', res);
        let  text = label(res, true);
        if (!text) {
            console.error(process.id, 'not ok- text not set for res:', res);
        }
//            console.error('ok - set text:', text);
//        } catch (e) {
//            process.stdout('beep');
//            console.error(process.id, ' ERR from split.js split()- failed to define text: res: ', res, e.message);
//            throw new Error(process.id, ' split failed on: ', res);
//        }
...
//        if (!text) console.error(process.id, ' no text for: ', res);
